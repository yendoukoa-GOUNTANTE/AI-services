...
> [!NOTE]
> This document provides a comprehensive catalog of the artifacts and components within the Yendoukoa AI ecosystem. Please note that this manifest serves as a snapshot of the current project state and may drift as the codebase evolves.
...
- **Database:** [`project.db`](project.db) (SQLite) containing Users, Agents, Designs, Purchases, and Files.

### 2. AI Intelligence Engine
- **Module:** [`google_ai.py`](google_ai.py)
...
- **Directory:** [`marketplace-frontend/`](marketplace-frontend/)
- **Technology:** React, Vite, TypeScript, Tailwind CSS, Lucide Icons.
- **Deployment Build:** Located in [`docs/`](docs/) for GitHub Pages hosting.
- **URL:** [https://yendoukoa.ai](https://yendoukoa.ai) (Local: [http://localhost:5173](http://localhost:5173))

### 4. Local Project Portal
- **Directory:** [`yendoukoa-ai-site/`](yendoukoa-ai-site/)
- **Entry Point:** [`yendoukoa-ai-site/index.html`](yendoukoa-ai-site/index.html)
...
- **Browser Extension:** [`extension/`](extension/) (Manifest v3, supporting Chrome and Firefox).
...
- **[`AGENTS.md`](AGENTS.md):** Onboarding guide for new AI agents joining the ecosystem.
- **[`CHANGELOG.md`](CHANGELOG.md):** Detailed version history and feature tracking.
- **[`CONTRIBUTING.md`](CONTRIBUTING.md):** Technical standards and contribution workflows.
- **[`requirements.txt`](requirements.txt):** Master list of backend dependencies.
- **[`setup.py`](setup.py):** Package configuration for the AI Services platform.
- **[`langflow_flows/`](langflow_flows/):** Visual AI workflow definitions for Langflow execution.
