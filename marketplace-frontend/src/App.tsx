          ...
          <form onSubmit={handleServiceExecution} className="space-y-8">
             ...
             <div className="flex items-center justify-between pt-8 border-t border-gray-50 dark:border-white/10">
                ...
                <div className="flex space-x-4">
                  {['elevenlabs', 'tiktok-market', 'whatsapp-biz', 'cloudinary-media', 'runway-video', 'excel-helper', 'word-helper', 'powerpoint-helper', 'calendly', 'xero-specialist', 'quickbooks-expert', 'airtable-architect', 'notion-architect', 'flutterwave', 'twilio', 'os-kernel', 'os-fs', 'os-process', 'emergent', 'devrev'].includes(selectedService?.id || '') && (
                    <button
                      type="button"
