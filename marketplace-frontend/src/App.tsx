...
const AI_SERVICES: AIService[] = [
  ...
  { id: 'perplexity-search', name: 'Perplexity Search', category: 'Advanced', icon: Search, description: 'Elite Perplexity architect for real-time grounded research and search-powered AI.', featured: true },
