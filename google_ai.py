...
def provide_automotive_security_assistance(prompt: str) -> str:
    ...
    system_prompt = (
        ...
        "Do not provide step-by-step exploit instructions or code that could be used to compromise vehicles; "
        "keep guidance high-level, defensive, and focused on secure design and implementation."
    )
